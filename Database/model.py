...
class User(Base):
    ...
    preferences: Mapped[JSON] = mapped_column(MutableDict.as_mutable(JSON), nullable=False, default={CHARS_ON_PAGE: 350, LANGUAGE: "ru", REMOVE_ENTERS: False, REMOVE_DASH: False})
